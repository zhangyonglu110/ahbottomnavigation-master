	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			try {
				...
				// Item colors
				titleColorActive = ta.getColor(R.styleable.AHBottomNavigationBehavior_Params_selectedColor, context.getResources().getColor(R.color.colorBottomNavigationAccent));
				titleColorInactive = ta.getColor(R.styleable.AHBottomNavigationBehavior_Params_normalColor, context.getResources().getColor(R.color.colorBottomNavigationInactive));
			} finally {
				ta.recycle();
			}
		}else{
